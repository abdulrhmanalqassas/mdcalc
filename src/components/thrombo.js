    ...
    <>
      ...
      <ThemeProvider theme={theme}>
        <Box marginX={5}>
          ...
          grade 1 or 2 TP is defined as platelet counts, which are not expected
          to decrease to grade 3 or 4 TP in the coming days to weeks. †AF with
          ...
          thrombosis; INR = international normalized
        </Box>
